...
def build_omission_data(args, logger, accelerator, tokenizer=None): #args로 데이터 넣어주는 거 같음. 
...
def group_omission_data(args, models=['bart_large', 'bart_base', 't5_base', 't5_small', 'baseline', 'pegasus']): # bart large 뺍시다
